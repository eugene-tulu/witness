/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ffcfaa17a294734dad05b1b788fb3873)
// Runtime types generated with workerd@1.20260329.1 2026-03-29 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "IncidentObject";
	}
	interface Env {
		INCIDENTS_KV: KVNamespace;
		AUDIO_BUCKET: R2Bucket;
		ASSETS: Fetcher;
		ELEVENLABS_VOICE_ID: "3lcAWfn51WJPwqbQ1Viu";
		INCIDENT: DurableObjectNamespace<import("./src/index").IncidentObject>;
	}
}
